...
export interface MultilineCardWithIconProps {
  // icon: FC<any>;
  to?: string;
...
const MultilineCardWithIcon: FC<MultilineCardWithIconProps> = props => {
...
const HeaderView: FC<MultilineCardWithIconProps> = props => {
  const {
    // icon,
    title,
    subtitle,
  ...
  return (
    ...
    >
      ...
      <Box className={classes.titleBox} textAlign='left'>
...
export default MultilineCardWithIcon;
