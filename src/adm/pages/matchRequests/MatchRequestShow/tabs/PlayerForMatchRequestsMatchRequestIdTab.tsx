...
const PlayerForMatchRequestsMatchRequestIdTab: FC<Omit<TabProps, 'children'>> = (props) => {
  return (<Tab {...props}>
    <ReferenceManyField
      label={false}
      reference='playerForMatchRequests'
      target='matchRequestId'
...
export default PlayerForMatchRequestsMatchRequestIdTab;
