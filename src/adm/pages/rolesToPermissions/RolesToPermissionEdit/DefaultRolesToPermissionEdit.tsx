    ...
    <Edit {...props}>
      ...
      >
        <FormGrid container spacing={2}>
          ...
          <FormGrid item xs={12} sm={6} md={3} lg={2}><ReferenceInput source="roleId" reference="roles">
      <AutocompleteInput fullWidth optionText="title" />
    </ReferenceInput></FormGrid>
          <FormGrid item xs={12} sm={6} md={3} lg={2}><ReferenceInput source="permissionId" reference="permissions">
      <AutocompleteInput fullWidth optionText="title" />
    </ReferenceInput></FormGrid>
        </FormGrid>
      </SimpleForm>
