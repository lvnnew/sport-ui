...
const DefaultToolbar = (props: ToolbarProps) => {
  ...
  return (
    ...
    >
      <SaveButton />
      {hasPermission(permissions, 'managerLoginTypes.delete') && <DeleteButton mutationMode='pessimistic' />}
    </Toolbar>
  );
};
...
const DefaultManagerLoginTypeEdit: FC<EditProps> = (props: EditProps) => {
...
export default DefaultManagerLoginTypeEdit;
