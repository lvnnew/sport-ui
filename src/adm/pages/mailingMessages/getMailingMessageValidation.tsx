...
const getMailingMessageValidation: GetValidation = (t: Translate) => Yup.object({
  mailingCampaignId: Yup.number().required(t('validation.required')).typeError(t('validation.required')),
  ...
  messageTemplateLangVariantId: Yup.number().required(t('validation.required')).typeError(t('validation.required')),
});
